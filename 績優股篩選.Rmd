...
### 使用資料
```{r}
SheetList = qread("C:/Users/user/Desktop/RAW_DATA")
filename <-"C:/Users/user/Desktop/FINAL.xlsx"
Ticker = read.csv("C:/Users/user/Desktop/sp500_ticker_category.csv")
EPS = qread("C:/Users/user/Desktop/DATA_EPS")
filename_EPS <-"C:/Users/user/Desktop/NAME_EPS.xlsx"
```
...
xtest = test[,1:24]
ytest = (test[,25])
train_balance[,25] = as.factor(as.numeric(train_balance[,25]))
rf = randomForest(formula = Y~.,x = train_balance[,1:24],y= train_balance[,25],xtest = xtest, ytest = ytest,ntree = 1000)
importance = importance(rf)
importance = rev(sort(importance))
...
controls=rpart.control(maxdepth= 4,cp = 0.05)
cart.model<- rpart(Y ~. ,
                   control = controls,
